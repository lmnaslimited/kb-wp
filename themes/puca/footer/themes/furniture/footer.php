...
$footer_customize_class	= ( puca_tbay_get_config('footer_remove_style', false) ) ? '-customize' : '';
?>
	...
	<footer id="tbay-footer<?php echo esc_attr($footer_customize_class); ?>" class="tbay-footer<?php echo esc_attr($footer_customize_class); ?> <?php echo (!empty($footer)) ? esc_attr($footer) : ''; ?>">
		<?php if ( !empty($footer) ): ?>
