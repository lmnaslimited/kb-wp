			                ...
			                <li class="yith-wfbt-item">
			                    <label for="offeringID_<?php echo esc_attr($j); ?>">
			                        ...
			                        <span class="product-name">
							            <?php echo ( ( $product_id == $main_product_id ) ? '<span>'. esc_html__( 'This item', 'puca' ) . ': &nbsp;</span>' : '' ) . sprintf( '%1$s <span class="att">%2$s</span>', $product->get_title(), wc_get_formatted_variation( $product, true ) ); ?>
			                        </span>
