	...
	<div class="row">
		...
		<div class="col-md-9">
			...
			<div class="cart-bottom clearfix actions">
				...
				<div class="pull-right update-cart">
					<input type="submit" class="btn btn-default update" name="update_cart" value="<?php esc_attr_e( 'Update Cart', 'puca' ); ?>" />
		...
		<div class="col-md-3">
			...
			<div class="coupon">
				...
				<div class="box"><input type="text" name="coupon_code" id="coupon_code" value="" class="text" /><span class="input-group-btn"><input type="submit" class="btn btn-default" name="apply_coupon" value="<?php esc_attr_e( 'Apply', 'puca' ); ?>" /></span></div>
