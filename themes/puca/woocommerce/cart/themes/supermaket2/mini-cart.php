		...
		<div class="mcart-border">
			...
			<?php if(sizeof(WC()->cart->get_cart()) > 0) : ?>
				<div class="group-button">
					...
					<p class="buttons">
						<a href="<?php echo esc_url( wc_get_checkout_url() );?>" class="button checkout"><i class="icon-lock"></i><?php esc_html_e('Checkout', 'puca'); ?></a>
						<a href="<?php echo esc_url( wc_get_cart_url() ); ?>" class="button view-cart"><i class="icon-basket"></i><?php esc_html_e('View Cart', 'puca'); ?></a>	
					</p>
				</div>
			<?php endif; ?>
