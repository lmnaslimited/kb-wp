...
if ( !function_exists ('puca_tbay_custom_styles') ) {
	function puca_tbay_custom_styles() {
		...
		<?php endif; ?>
			...
			.mm-menu .sub-menu .widget.widget_layered_nav ul li.active a, 
			.mm-menu .sub-menu .widget.widget_nav_menu ul li.active a, 
			.mm-menu .sub-menu .widget.widget_product_categories ul li.active a {
				color:<?php echo esc_html( puca_tbay_get_config('main_color') ) ?>;
			}
			...
			.tbay-slider-for .slick-arrow:hover:after, .product-block .yith-wcwl-add-to-wishlist > div.yith-wcwl-add-button a.delete_item, .questions-section span.question-symbol, .questions-section span.answer-symbol {
				border-color: <?php echo esc_html( puca_tbay_get_config('main_color') ) ?>;
				background: <?php echo esc_html( puca_tbay_get_config('main_color') ) ?> ;
			}
			.woocommerce-account #main-content .woocommerce form.login > p a, .singular-shop div.product .information .yith-wcwl-add-to-wishlist a.delete_item, .questions-section span.question a:hover, .questions-section span.question a:focus, .questions-section #show-all-questions a.show-questions:hover, .questions-section #show-all-questions a.show-questions:focus {
				color: <?php echo esc_html( puca_tbay_get_config('main_color') ) ?>;
			}
			...
			.dokan-single-store .profile-frame .profile-info-box .profile-info-summery-wrapper .profile-info-summery .profile-info .dokan-store-info i, ul.subsubsub li.active a, .dokan-withdraw-content .dokan-withdraw-area ul li.active a {
				color: <?php echo esc_html( puca_tbay_get_config('main_color') ) ?>;
			}
			.dokan-seller-listing .store-footer > a, body input[type="submit"].dokan-btn, body .dokan-btn-theme,  body a.dokan-btn-theme, body .dokan-btn-theme {
				background: <?php echo esc_html( puca_tbay_get_config('main_color') ) ?>;
				border-color: <?php echo esc_html( puca_tbay_get_config('main_color') ) ?>;
			}
			...
			.wcmp_vendor_banner_template.template3 a.wcmp_vendor_detail:hover, #wcmp-store-conatiner .wcmp-store-list .wcmp-store-detail-wrap .wcmp-store-detail-list li .wcmp_vendor_detail {
				color: <?php echo esc_html( puca_tbay_get_config('main_color') ) ?>;
			}
			.widget_wcmp_quick_info #respond input#submit, .woocommerce #reviews #wcmp_vendor_reviews #respond .form-submit input,
			#wcmp-store-conatiner input[type="submit"], .wcmp_regi_main .register button.button, #qna-ask-input button#ask-qna {
				background: <?php echo esc_html( puca_tbay_get_config('main_color') ) ?>;
				border-color: <?php echo esc_html( puca_tbay_get_config('main_color') ) ?>;
			}

			/*Main color review image + YITH FBT*/
			
			.yith-wfbt-section .yith-wfbt-item input[type=checkbox]:checked + i, #comments .wcpr-overall-rating-and-rating-count .wcpr-overall-rating .wcpr-overall-rating-left {
				color: <?php echo esc_html( puca_tbay_get_config('main_color') ) ?>;
			}
			...
			.woocommerce .yith-wfbt-submit-block .yith-wfbt-submit-button-remove, .yith-wfbt-section .yith-wfbt-images .image-td:hover {
				border-color: <?php echo esc_html( puca_tbay_get_config('main_color') ) ?>;
			}
			...
			/*WC Vendor*/
			[class*="multi-viewed-"] .owl-carousel .slick-arrow:hover, .agree-to-terms-container .checkbox a, .woocommerce-MyAccount-content a, ul.wcv_vendorslist a.button:hover, ul.wcv_vendorslist a.button:focus, .product-block .wcvendors_sold_by_in_loop a:hover {
				color: <?php echo esc_html( puca_tbay_get_config('main_color') ) ?>;
			}
			.form-row input[name="apply_for_vendor_submit"], .dashboard .wcv-dashboard-navigation ~ form input.btn-inverse[type="submit"] {
				background-color: <?php echo esc_html( puca_tbay_get_config('main_color') ) ?>;
				border-color: <?php echo esc_html( puca_tbay_get_config('main_color') ) ?>;
			}
			...
			.widget-newletter .btn-default, .product-block.list .yith-wcwl-wishlistexistsbrowse a, 
			...
			.tbay-login:hover i, .singular-shop div.product .information .compare.added
			{
				color:<?php echo esc_html( puca_tbay_get_config('main_color') ) ?> !important;
			}
