...
if ( !function_exists ('puca_tbay_custom_styles') ) {
	function puca_tbay_custom_styles() {
		...
		<?php endif; ?>
			...
			.footer-device-mobile > *.active a i, .elementor-text-editor a, .questions-section span.question a:hover, .questions-section span.question a:focus, .questions-section #show-all-questions a.show-questions:hover, .questions-section #show-all-questions a.show-questions:focus	{
				color:<?php echo esc_html( puca_tbay_get_config('main_color') ) ?>;
			}
			...
			.tbay-slider-for .slick-arrow:hover:after, .questions-section span.question-symbol, .questions-section span.answer-symbol {
				background: <?php echo esc_html( puca_tbay_get_config('main_color') ) ?>;
			...
			@media (max-width: 767px) {
				...
				.product-block .yith-wcwl-add-to-wishlist > div.yith-wcwl-add-button a.delete_item, .product-block.list .yith-wcwl-wishlistexistsbrowse > a, .product-block.list .yith-wcwl-wishlistaddedbrowse > a, .product-block .yith-wcwl-wishlistexistsbrowse > a, .product-block .yith-wcwl-wishlistaddedbrowse > a, .product-block .yith-compare > a:hover, .product-block .yith-wcwl-add-to-wishlist a:hover, .product-block .yith-wcqv-button:hover {
					color: <?php echo esc_html( puca_tbay_get_config('main_color') ) ?> !important;
				}
				#checkout_timeline.horizontal.text li.active .timeline-wrapper a.timeline-label, .product-block .groups-button-image > .button-wishlist a:hover, .product-block .groups-button-image > .button-wishlist a:focus {
					color: <?php echo esc_html( puca_tbay_get_config('main_color') ) ?>;
				}
				.image-mains .flex-control-nav .slick-arrow:hover.owl-prev, .image-mains .flex-control-nav .slick-arrow:hover.owl-next {
					background: <?php echo esc_html( puca_tbay_get_config('main_color') ) ?> !important;
				}
			}
