...
if ( !function_exists ('puca_tbay_custom_styles') ) {
	function puca_tbay_custom_styles() {
		...
		<?php endif; ?>
			...
			.metis.tparrows:hover:before, .questions-section span.question-symbol, .questions-section span.answer-symbol {
				color: #fff !important;
			}
			...
			.singular-shop div.product .information .tbay-compare a.added:hover, .product-block .yith-wcwl-add-to-wishlist > div.yith-wcwl-add-button a.delete_item, .questions-section span.question-symbol, .questions-section span.answer-symbol {
			...
			/* WCFM */
			#wcfmmp-store .categories_list ul li a:hover, #wcfmmp-store .categories_list ul li a.active, #wcfm_membership_container .wcfm-content .terms_title.wcfm_title a, #tbay-cart-modal .wcfm_appointment_title:hover, #tbay-cart-modal .wcfm_auctions_title:hover, #tbay-cart-modal .wcfm_booking_title:hover, #tbay-cart-modal .wcfm_coupon_title:hover, #tbay-cart-modal .wcfm_dashboard_item_title:hover, #tbay-cart-modal .wcfm_listing_title:hover, #tbay-cart-modal .wcfm_order_title:hover, #tbay-cart-modal .wcfm_product_title:hover, .wcfmmp_sold_by_container_advanced .wcfmmp_sold_by_wrapper .wcfmmp_sold_by_store a:hover, .wcfmmp_sold_by_container_advanced .wcfmmp_sold_by_wrapper .wcfmmp_sold_by_store a:focus {
				color: <?php echo esc_html( puca_tbay_get_config('main_color') ) ?> !important;
			}
			...
			/* WC Vendor */
			ul.wcv_vendorslist a.button:hover, ul.wcv_vendorslist a.button:focus, .product-block .wcvendors_sold_by_in_loop a:hover, [class*="multi-viewed-"] .owl-carousel .slick-arrow:hover, .woocommerce-MyAccount-content a {
				color:<?php echo esc_html( puca_tbay_get_config('main_color') ) ?>;
			}
			.woocommerce-account #main-content .woocommerce button[type="submit"], .woocommerce-account #main-content .woocommerce input[type="submit"], .wcv-dashboard-navigation ul li a, .dashboard .wcv-dashboard-navigation ~ form input.btn-inverse[type="submit"] {
				background-color: <?php echo esc_html( puca_tbay_get_config('main_color') ) ?>;
			}
			.woocommerce-account #main-content .woocommerce button[type="submit"], .woocommerce-account #main-content .woocommerce input[type="submit"], .wcv-dashboard-navigation ul li a, .dashboard .wcv-dashboard-navigation ~ form input.btn-inverse[type="submit"] {
				border-bottom-color: <?php echo esc_html( puca_tbay_get_config('button_border_color') ) ?>;
			}
			.button:hover, .dashboard .wcv-dashboard-navigation ~ form input.btn-inverse[type="submit"]:hover, .dashboard .wcv-dashboard-navigation ~ form input.btn-inverse[type="submit"]:focus {
				background: <?php echo esc_html( puca_tbay_get_config('button_hover_color') ) ?> !important;
				border-bottom-color: <?php echo esc_html( puca_tbay_get_config('button_border_color_hover') ) ?>;
			}
			...
			@media (max-width: 767px) {
				...
				#checkout_timeline.horizontal.text li.active .timeline-wrapper a.timeline-label, .product-block .yith-wcwl-add-to-wishlist > div.yith-wcwl-add-button a:hover {
					color: <?php echo esc_html( puca_tbay_get_config('main_color') ) ?>;
				}
			}
			...
			#wcfm_membership_container input.wcfm_submit_button:hover, #wcfm_membership_container input.wcfm_submit_button:focus, #wcfm_membership_container a.wcfm_submit_button:hover, #wcfm_membership_container a.wcfm_submit_button:focus {
			...
			.questions-section #ywqa-submit-question, input[type="submit"].dokan-btn, a.dokan-btn-theme, 
			.dokan-btn-theme, .dokan-btn-success, input[type="submit"].dokan-btn[disabled], 
			a.dokan-btn-theme[disabled], .dokan-btn-theme[disabled], .dokan-btn-success[disabled],
			...
			.coupon .box input[type=submit]:hover, input[type="submit"].dokan-btn-theme:hover, a.dokan-btn-theme:hover, .dokan-btn-theme:hover, input[type="submit"].dokan-btn-theme:focus, a.dokan-btn-theme:focus, .dokan-btn-theme:focus, input[type="submit"].dokan-btn-theme:active, a.dokan-btn-theme:active, .dokan-btn-theme:active, input[type="submit"].dokan-btn-theme.active, a.dokan-btn-theme.active, .dokan-btn-theme.active, #wcfm-content #wcfm_membership_container input.wcfm_submit_button:hover, #wcfm-content #wcfm_membership_container input.wcfm_submit_button:focus, #wcfm-content #wcfm_membership_container a.wcfm_submit_button:hover, #wcfm-content #wcfm_membership_container a.wcfm_submit_button:focus
			{
			...
			#wcfm_membership_container input.wcfm_submit_button:hover {
				border-color: <?php echo esc_html( puca_tbay_get_config('button_hover_color') ) ?>;
			}
			...
			.product-block.list .yith-wcqv-button.compare.added:hover {
				background: <?php echo esc_html( puca_tbay_get_config('main_color2') ) ?> !important;
				border-bottom: 3px solid <?php echo esc_html( puca_tbay_get_config('main_color2') ) ?> !important;
			}
			...
			.more_products a, 
			.show-view-all a,
			.tbay-pagination-load-more a, .widget-features.style3 .feature-box-group .feature-box:before,
			...
			.product-block .yith-wcwl-wishlistexistsbrowse > a, .product-block .yith-compare > a.added {
				border-bottom-color: <?php echo esc_html( puca_tbay_get_config('button_border_color') ) ?> !important;
			}
			...
			body table.compare-list .add-to-cart td a.button {
				background-color: <?php echo esc_html( puca_tbay_get_config('button_hover_color') ) ?>  !important;
				border-color: <?php echo esc_html( puca_tbay_get_config('button_hover_color') ) ?>  !important;
			} 
			body table.compare-list .add-to-cart td a.button:hover {
			...
			/**********************************button border color*****************************/
			<?php if ( puca_tbay_get_config('button_border_color') != "" ) : ?>
				.product-block .yith-wcwl-wishlistexistsbrowse > a {
					border-bottom-color: <?php echo esc_html( puca_tbay_get_config('button_border_color') ) ?> !important;
				}
			<?php endif; ?>
			...
			<?php if ( puca_tbay_get_config('button_border_color_hover') != "" ) : ?>
