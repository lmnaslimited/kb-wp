...
if ( !function_exists ('puca_tbay_custom_styles') ) {
	function puca_tbay_custom_styles() {
		...
		<?php endif; ?>
			...
			#checkout_timeline.text li.active .timeline-wrapper a.timeline-label, .navbar-nav.megamenu > li .button-wishlist .yith-wcwl-wishlistexistsbrowse > a, .navbar-nav.megamenu > li .button-wishlist .yith-wcwl-wishlistaddedbrowse > a {
				color: <?php echo esc_html( puca_tbay_get_config('main_color') ) ?>;
			}  
			...
			.ui-autocomplete.ui-widget-content .price > .woocs_price_code > ins
			{
			...
			.wvs-css .variable-item.image-variable-item.selected, .wvs-css .variable-item.image-variable-item:hover {
				border-color: <?php echo esc_html( puca_tbay_get_config('main_color') ) ?> ;
			}
			.wvs-css .variable-item.button-variable-item.selected, .wvs-css .variable-item.button-variable-item:hover, .product-block.list .yith-wcwl-add-to-wishlist > div.yith-wcwl-add-button a.delete_item, .questions-section span.question-symbol, .questions-section span.answer-symbol {
				border-color: <?php echo esc_html( puca_tbay_get_config('main_color') ) ?> ;
				background: <?php echo esc_html( puca_tbay_get_config('main_color') ) ?> ;
			}
			.woocommerce-message,
			...
			.widget_tbay_popup_newsletter .input-group-btn .form-control-feedback, .singular-shop div.product .information .yith-wcwl-add-to-wishlist a.delete_item, .questions-section span.question a:hover, .questions-section span.question a:focus, .questions-section #show-all-questions a.show-questions:hover, .questions-section #show-all-questions a.show-questions:focus {
				color: <?php echo esc_html( puca_tbay_get_config('main_color') ) ?>;
			}
			.entry-date a,
			...
			/* WCMP */
			#wcmp-store-conatiner .wcmp-store-list .wcmp-store-detail-wrap .wcmp-store-detail-list li .wcmp_vendor_detail, .wcmp_vendor_banner_template.template3 a.wcmp_vendor_detail:hover, ul.show-brand li a:hover {
				color: <?php echo esc_html( puca_tbay_get_config('main_color') ) ?>;
			}
			#wcmp-store-conatiner input[type="submit"], .widget_wcmp_quick_info #respond input#submit, .woocommerce #reviews #wcmp_vendor_reviews #respond .form-submit input, .wcmp_regi_main .register button.button, #qna-ask-input button#ask-qna {
				background-color: <?php echo esc_html( puca_tbay_get_config('main_color') ) ?>;
				border-color: <?php echo esc_html( puca_tbay_get_config('main_color') ) ?>;
			}
			#wcmp-store-conatiner input[type="submit"]:hover, #wcmp-store-conatiner input[type="submit"]:focus, .woocommerce #reviews #wcmp_vendor_reviews #respond .form-submit input:hover, .woocommerce #reviews #wcmp_vendor_reviews #respond .form-submit input:focus, .wcmp_regi_main .register button.button:hover, .wcmp_regi_main .register button.button:focus, .woocommerce a.button:hover, .woocommerce button.button:hover, .woocommerce input.button:hover, .woocommerce #respond input#submit:hover {
			...
			.form-row input[name="apply_for_vendor_submit"]:hover, .form-row input[name="apply_for_vendor_submit"]:focus, .dashboard .wcv-dashboard-navigation ~ form input.btn-inverse[type="submit"]:hover, .dashboard .wcv-dashboard-navigation ~ form input.btn-inverse[type="submit"]:focus  {
			...
			.verticle-menu .navbar-nav > li:hover > a, .questions-section span.question-symbol, .questions-section span.answer-symbol {
				color: #fff !important;
			}
			...
			.product-block .groups-button > div > a.added_to_cart.wc-forward:hover
			{
				background: <?php echo esc_html( puca_tbay_get_config('main_color') ) ?>  !important;
			}
			.product-block .groups-button > div > a.compare.added {
				background: <?php echo esc_html( puca_tbay_get_config('main_color') ) ?>  !important;
				border-color: <?php echo esc_html( puca_tbay_get_config('main_color') ) ?>  !important;
			}
			...
			<?php if ( puca_tbay_get_config('main_color2') != "" ) : ?>
				...
				.tbay-to-top a:hover, .tbay-to-top button.btn-search-totop:hover, .dokan-seller-listing .store-footer > a {
					border-color: <?php echo esc_html( puca_tbay_get_config('main_color2') ) ?> !important;
				}

				body table.compare-list .add-to-cart td a.button, .dokan-seller-listing .store-footer > a:active, .dokan-seller-listing .store-footer > a:hover, .dokan-seller-listing .store-footer > a:focus {
					background: <?php echo esc_html( puca_tbay_get_config('main_color2') ) ?> !important;
					border-color: <?php echo esc_html( puca_tbay_get_config('main_color2') ) ?> !important;	
					color: #fff !important;
				}
				body table.compare-list .add-to-cart td a.button:hover, .dokan-seller-listing .store-footer > a {
