...
if ( !function_exists ('puca_tbay_custom_styles') ) {
	function puca_tbay_custom_styles() {
		...
		<?php endif; ?>
			...
			.mc4wp-response .mc4wp-alert:after, .tbay-footer ul.menu li.active a, .footer-device-mobile > *.active a, body.woocommerce-wishlist .footer-device-mobile > .device-wishlist a, body.woocommerce-wishlist .footer-device-mobile > .device-wishlist a i, .flex-control-nav.flex-control-thumbs .slick-arrow:hover:after, .style-slide .tbay-slider-for .slick-arrow:hover, .questions-section span.question a:hover, .questions-section span.question a:focus, .questions-section #show-all-questions a.show-questions:hover, .questions-section #show-all-questions a.show-questions:focus {
			...
			/* WCMP */
			#wcmp-store-conatiner .wcmp-store-list .wcmp-store-detail-wrap .wcmp-store-detail-list li .wcmp_vendor_detail, .wcmp_vendor_banner_template.template3 a.wcmp_vendor_detail:hover {
				color:<?php echo esc_html( puca_tbay_get_config('main_color') ) ?>;
			}
			...
			.popup-cart .gr-buttons a:first-child, .questions-section span.question-symbol, .questions-section span.answer-symbol,
			...
			@media (max-width: 767px) {
				...
				#checkout_timeline.horizontal.text li.active .timeline-wrapper a.timeline-label, .product-block .group-buttons > div.button-wishlist a:hover i, .product-block .group-image > div.button-wishlist a:hover i, .product-block.list .group-buttons > div.button-wishlist a:hover i {
					color: <?php echo esc_html( puca_tbay_get_config('main_color') ) ?>;
				}
			}
			...
			/* Color Dokan*/
			.dokan-seller-listing #dokan-seller-listing-wrap ul.dokan-seller-wrap li .store-footer > a {
				border-color: <?php echo esc_html( puca_tbay_get_config('main_color2') ) ?> !important;
				color:<?php echo esc_html( puca_tbay_get_config('main_color2') ) ?>;
			}

			.dokan-seller-listing .store-footer > a:hover, .dokan-seller-listing .store-footer > a:focus {
				background:  <?php echo esc_html( puca_tbay_get_config('main_color2') ) ?>;
				border-color: <?php echo esc_html( puca_tbay_get_config('main_color2') ) ?>;
				color: #fff !important;
			}
