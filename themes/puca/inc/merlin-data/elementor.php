...
class Puca_Merlin_Elementor {
	public function import_files_wpb_el_fashion_v1(){
		...
		return array(
			array(
				...
				'preview_url'                => 'https://elementor.thembay.com/puca/',
			...
			array(
				...
				'import_notice'              => esc_html__( 'After you import this demo, you will have to setup the slider separately.', 'puca' ),
				'preview_url'                => 'https://elementor.thembay.com/puca/home-4/',
			),
			array(
				...
				'import_notice'              => esc_html__( 'After you import this demo, you will have to setup the slider separately.', 'puca' ),
				'preview_url'                => 'https://elementor.thembay.com/puca/home-5/',
			),
			array(
				...
				'import_notice'              => esc_html__( 'After you import this demo, you will have to setup the slider separately.', 'puca' ),
				'preview_url'                => 'https://elementor.thembay.com/puca/home-6/',
			),
			array(
				...
				'import_notice'              => esc_html__( 'After you import this demo, you will have to setup the slider separately.', 'puca' ),
				'preview_url'                => 'https://elementor.thembay.com/puca/home-7/',
			),
			array(
				...
				'import_notice'              => esc_html__( 'After you import this demo, you will have to setup the slider separately.', 'puca' ),
				'preview_url'                => 'https://elementor.thembay.com/puca/home-8/',
			),
			array(
				...
				'import_notice'              => esc_html__( 'After you import this demo, you will have to setup the slider separately.', 'puca' ),
				'preview_url'                => 'https://elementor.thembay.com/puca/home-9/',
			),
			array(
				...
				'import_notice'              => esc_html__( 'After you import this demo, you will have to setup the slider separately.', 'puca' ),
				'preview_url'                => 'https://elementor.thembay.com/puca/home-10/',
			),
			array(
				...
				'import_notice'              => esc_html__( 'After you import this demo, you will have to setup the slider separately.', 'puca' ),
				'preview_url'                => 'https://elementor.thembay.com/puca/home-11/',
			),
			array(
				...
				'import_notice'              => esc_html__( 'After you import this demo, you will have to setup the slider separately.', 'puca' ),
				'preview_url'                => 'https://elementor.thembay.com/puca/home-12/',
			),
			array(
				...
				'import_notice'              => esc_html__( 'After you import this demo, you will have to setup the slider separately.', 'puca' ),
				'preview_url'                => 'https://elementor.thembay.com/puca/home-13/',
			),
			array(
				...
				'import_notice'              => esc_html__( 'After you import this demo, you will have to setup the slider separately.', 'puca' ),
				'preview_url'                => 'https://elementor.thembay.com/puca/home-14/',
				'group_label_end'          => 'yes',
			),
		);
	}
	...
	public function import_files_wpb_el_fashion_v2(){
		...
		return array(
			array(
				...
				'import_preview_image_url'   => "https://bitbucket.org/devthembay/update-plugin/raw/master/demosamples/puca/${prefix}/${skin}/home1/screenshot.jpg",
				'import_notice'              => esc_html__( 'After you import this demo, you will have to setup the slider separately.', 'puca' ),
				'preview_url'                => 'https://elementor.thembay.com/puca_fashion2/',
				'group_label_start'          => 'yes',
				'group_label_name'          => $prefix_name.' '. $skin_name,
			),
			array(
				...
				'import_preview_image_url'   => "https://bitbucket.org/devthembay/update-plugin/raw/master/demosamples/puca/${prefix}/${skin}/home2/screenshot.jpg",
				'import_notice'              => esc_html__( 'After you import this demo, you will have to setup the slider separately.', 'puca' ),
				'preview_url'                => 'https://elementor.thembay.com/puca_fashion2/home-2/',
			),
			array(
				'import_file_name'           => 'Home 3',
				'home'                       => 'home-3',
				...
				'import_preview_image_url'   => "https://bitbucket.org/devthembay/update-plugin/raw/master/demosamples/puca/${prefix}/${skin}/home3/screenshot.jpg",
				'import_notice'              => esc_html__( 'After you import this demo, you will have to setup the slider separately.', 'puca' ),
				'preview_url'                => 'https://elementor.thembay.com/puca_fashion2/home-3/',
			),
			array(
				'import_file_name'           => 'Home 4',
				'home'                       => 'home-4',
				...
				'import_preview_image_url'   => "https://bitbucket.org/devthembay/update-plugin/raw/master/demosamples/puca/${prefix}/${skin}/home4/screenshot.jpg",
				'import_notice'              => esc_html__( 'After you import this demo, you will have to setup the slider separately.', 'puca' ),
				'preview_url'                => 'https://elementor.thembay.com/puca_fashion2/home-4/',
			),
			array(
				'import_file_name'           => 'Home 5',
				'home'                       => 'home-5',
				...
				'import_preview_image_url'   => "https://bitbucket.org/devthembay/update-plugin/raw/master/demosamples/puca/${prefix}/${skin}/home5/screenshot.jpg",
				'import_notice'              => esc_html__( 'After you import this demo, you will have to setup the slider separately.', 'puca' ),
				'preview_url'                => 'https://elementor.thembay.com/puca_fashion2/home-5/',
			),
			array(
				'import_file_name'           => 'Home 6',
				'home'                       => 'home-6',
				...
				'import_preview_image_url'   => "https://bitbucket.org/devthembay/update-plugin/raw/master/demosamples/puca/${prefix}/${skin}/home6/screenshot.jpg",
				'import_notice'              => esc_html__( 'After you import this demo, you will have to setup the slider separately.', 'puca' ),
				'preview_url'                => 'https://elementor.thembay.com/puca_fashion2/home-6/',
			),
			array(
				'import_file_name'           => 'Home 7',
				'home'                       => 'home-7',
				...
				'import_preview_image_url'   => "https://bitbucket.org/devthembay/update-plugin/raw/master/demosamples/puca/${prefix}/${skin}/home7/screenshot.jpg",
				'import_notice'              => esc_html__( 'After you import this demo, you will have to setup the slider separately.', 'puca' ),
				'preview_url'                => 'https://elementor.thembay.com/puca_fashion2/home-7/',
			),
			array(
				'import_file_name'           => 'Home 8',
				'home'                       => 'home-8',
				...
				'import_preview_image_url'   => "https://bitbucket.org/devthembay/update-plugin/raw/master/demosamples/puca/${prefix}/${skin}/home8/screenshot.jpg",
				'import_notice'              => esc_html__( 'After you import this demo, you will have to setup the slider separately.', 'puca' ),
				'preview_url'                => 'https://elementor.thembay.com/puca_fashion2/home-8/',
			),
			array(
				'import_file_name'           => 'Home 9',
				'home'                       => 'home-9',
				...
				'import_preview_image_url'   => "https://bitbucket.org/devthembay/update-plugin/raw/master/demosamples/puca/${prefix}/${skin}/home9/screenshot.jpg",
				'import_notice'              => esc_html__( 'After you import this demo, you will have to setup the slider separately.', 'puca' ),
				'preview_url'                => 'https://elementor.thembay.com/puca_fashion2/home-9/',
				'group_label_end'          => 'yes',
			),
		);
	}
	...
	public function import_files_wpb_el_smarket_v1(){
		...
		return array(
			array(
				...
				'import_preview_image_url'   => "https://bitbucket.org/devthembay/update-plugin/raw/master/demosamples/puca/${prefix}/${skin}/home1/screenshot.jpg",
				'import_notice'              => esc_html__( 'After you import this demo, you will have to setup the slider separately.', 'puca' ),
				'preview_url'                => 'https://elementor.thembay.com/puca_smarket/',
				'group_label_start'          => 'yes',
				'group_label_name'          => $prefix_name.' '. $skin_name,
			),
			array(
				...
				'import_preview_image_url'   => "https://bitbucket.org/devthembay/update-plugin/raw/master/demosamples/puca/${prefix}/${skin}/home2/screenshot.jpg",
				'import_notice'              => esc_html__( 'After you import this demo, you will have to setup the slider separately.', 'puca' ),
				'preview_url'                => 'https://elementor.thembay.com/puca_smarket/home-2',
			),
			array(
				'import_file_name'           => 'Home 3',
				'home'                       => 'home-3',
				...
				'import_preview_image_url'   => "https://bitbucket.org/devthembay/update-plugin/raw/master/demosamples/puca/${prefix}/${skin}/home3/screenshot.jpg",
				'import_notice'              => esc_html__( 'After you import this demo, you will have to setup the slider separately.', 'puca' ),
				'preview_url'                => 'https://elementor.thembay.com/puca_smarket/home-3',
				'group_label_end'          => 'yes',
			),
		);
	}
	...
	public function import_files_wpb_el_smarket_dokan(){
		...
		$rev_sliders = [
			...
			"https://bitbucket.org/devthembay/update-plugin/raw/master/demosamples/puca/${prefix}/${skin}/revslider/smarket-home2.zip",
			"https://bitbucket.org/devthembay/update-plugin/raw/master/demosamples/puca/${prefix}/${skin}/revslider/smarket-home3.zip",
			"https://bitbucket.org/devthembay/update-plugin/raw/master/demosamples/puca/${prefix}/${skin}/revslider/slide-vendor.zip",
		];
		...
		return array(
			array(
				...
				'import_preview_image_url'   => "https://bitbucket.org/devthembay/update-plugin/raw/master/demosamples/puca/${prefix}/${skin}/home1/screenshot.jpg",
				'import_notice'              => esc_html__( 'After you import this demo, you will have to setup the slider separately.', 'puca' ),
				'preview_url'                => 'https://elementor.thembay.com/puca_dokan/',
				'group_label_start'          => 'yes',
				'group_label_name'          => $prefix_name.' '. $skin_name,
			),
			array(
				...
				'import_preview_image_url'   => "https://bitbucket.org/devthembay/update-plugin/raw/master/demosamples/puca/${prefix}/${skin}/home2/screenshot.jpg",
				'import_notice'              => esc_html__( 'After you import this demo, you will have to setup the slider separately.', 'puca' ),
				'preview_url'                => 'https://elementor.thembay.com/puca_dokan/home-2',
			),
			array(
				'import_file_name'           => 'Home 3',
				'home'                       => 'home-3',
				...
				'import_preview_image_url'   => "https://bitbucket.org/devthembay/update-plugin/raw/master/demosamples/puca/${prefix}/${skin}/home3/screenshot.jpg",
				'import_notice'              => esc_html__( 'After you import this demo, you will have to setup the slider separately.', 'puca' ),
				'preview_url'                => 'https://elementor.thembay.com/puca_dokan/home-3',
				'group_label_end'          => 'yes',
			),
		);
	}
	...
	public function import_files_wpb_el_smarket_wcfm(){
		...
		return array(
			array(
				...
				'import_preview_image_url'   => "https://bitbucket.org/devthembay/update-plugin/raw/master/demosamples/puca/${prefix}/${skin}/home1/screenshot.jpg",
				'import_notice'              => esc_html__( 'After you import this demo, you will have to setup the slider separately.', 'puca' ),
				'preview_url'                => 'https://elementor.thembay.com/puca_wcfm/',
				'group_label_start'          => 'yes',
				'group_label_name'          => $prefix_name.' '. $skin_name,
			),
			array(
				...
				'import_preview_image_url'   => "https://bitbucket.org/devthembay/update-plugin/raw/master/demosamples/puca/${prefix}/${skin}/home2/screenshot.jpg",
				'import_notice'              => esc_html__( 'After you import this demo, you will have to setup the slider separately.', 'puca' ),
				'preview_url'                => 'https://elementor.thembay.com/puca_wcfm/home-2',
			),
			array(
				'import_file_name'           => 'Home 3',
				'home'                       => 'home-3',
				...
				'import_preview_image_url'   => "https://bitbucket.org/devthembay/update-plugin/raw/master/demosamples/puca/${prefix}/${skin}/home3/screenshot.jpg",
				'import_notice'              => esc_html__( 'After you import this demo, you will have to setup the slider separately.', 'puca' ),
				'preview_url'                => 'https://elementor.thembay.com/puca_wcfm/home-3',
				'group_label_end'          => 'yes',
			),
		);
	}
	...
	public function import_files_wpb_el_smarket_wcmp(){
		$prefix_name = 'Elementor';
		$prefix 	 = 'elementor';
		...
		return array(
			array(
				...
				'import_preview_image_url'   => "https://bitbucket.org/devthembay/update-plugin/raw/master/demosamples/puca/${prefix}/${skin}/home1/screenshot.jpg",
				'import_notice'              => esc_html__( 'After you import this demo, you will have to setup the slider separately.', 'puca' ),
				'preview_url'                => 'https://elementor.thembay.com/puca_wcmp/',
				'group_label_start'          => 'yes',
				'group_label_name'          => $prefix_name.' '. $skin_name,
			),
			array(
				...
				'import_preview_image_url'   => "https://bitbucket.org/devthembay/update-plugin/raw/master/demosamples/puca/${prefix}/${skin}/home2/screenshot.jpg",
				'import_notice'              => esc_html__( 'After you import this demo, you will have to setup the slider separately.', 'puca' ),
				'preview_url'                => 'https://elementor.thembay.com/puca_wcmp/home-2',
			),
			array(
				'import_file_name'           => 'Home 3',
				'home'                       => 'home-3',
				...
				'import_preview_image_url'   => "https://bitbucket.org/devthembay/update-plugin/raw/master/demosamples/puca/${prefix}/${skin}/home3/screenshot.jpg",
				'import_notice'              => esc_html__( 'After you import this demo, you will have to setup the slider separately.', 'puca' ),
				'preview_url'                => 'https://elementor.thembay.com/puca_wcmp/home-3',
				'group_label_end'          => 'yes',
			),
		);
	}
	...
	public function import_files_wpb_el_smarket_wcvendors(){
		...
		return array(
			array(
				...
				'import_preview_image_url'   => "https://bitbucket.org/devthembay/update-plugin/raw/master/demosamples/puca/${prefix}/${skin}/home1/screenshot.jpg",
				'import_notice'              => esc_html__( 'After you import this demo, you will have to setup the slider separately.', 'puca' ),
				'preview_url'                => 'https://elementor.thembay.com/puca_wcvendors/',
				'group_label_start'          => 'yes',
				'group_label_name'          => $prefix_name.' '. $skin_name,
			),
			array(
				...
				'import_preview_image_url'   => "https://bitbucket.org/devthembay/update-plugin/raw/master/demosamples/puca/${prefix}/${skin}/home2/screenshot.jpg",
				'import_notice'              => esc_html__( 'After you import this demo, you will have to setup the slider separately.', 'puca' ),
				'preview_url'                => 'https://elementor.thembay.com/puca_wcvendors/home-2',
			),
			array(
				'import_file_name'           => 'Home 3',
				'home'                       => 'home-3',
				...
				'import_preview_image_url'   => "https://bitbucket.org/devthembay/update-plugin/raw/master/demosamples/puca/${prefix}/${skin}/home3/screenshot.jpg",
				'import_notice'              => esc_html__( 'After you import this demo, you will have to setup the slider separately.', 'puca' ),
				'preview_url'                => 'https://elementor.thembay.com/puca_wcvendors/home-3',
				'group_label_end'          => 'yes',
			),
		);
	}
	...
	public function import_files_wpb_el_smarket_v2(){
		...
		return array(
			array(
				...
				'import_preview_image_url'   => "https://bitbucket.org/devthembay/update-plugin/raw/master/demosamples/puca/${prefix}/${skin}/home1/screenshot.jpg",
				'import_notice'              => esc_html__( 'After you import this demo, you will have to setup the slider separately.', 'puca' ),
				'preview_url'                => 'https://elementor.thembay.com/puca_smarket2/',
				'group_label_start'          => 'yes',
				'group_label_name'          => $prefix_name.' '. $skin_name,
			),
			array(
				...
				'import_preview_image_url'   => "https://bitbucket.org/devthembay/update-plugin/raw/master/demosamples/puca/${prefix}/${skin}/home2/screenshot.jpg",
				'import_notice'              => esc_html__( 'After you import this demo, you will have to setup the slider separately.', 'puca' ),
				'preview_url'                => 'https://elementor.thembay.com/puca_smarket2/home-2/',
			),
			array(
				'import_file_name'           => 'Home 3',
				'home'                       => 'home-3',
				...
				'import_preview_image_url'   => "https://bitbucket.org/devthembay/update-plugin/raw/master/demosamples/puca/${prefix}/${skin}/home3/screenshot.jpg",
				'import_notice'              => esc_html__( 'After you import this demo, you will have to setup the slider separately.', 'puca' ),
				'preview_url'                => 'https://elementor.thembay.com/puca_smarket2/home-3/',
			),
			array(
				'import_file_name'           => 'Home 4',
				'home'                       => 'home-4',
				...
				'import_preview_image_url'   => "https://bitbucket.org/devthembay/update-plugin/raw/master/demosamples/puca/${prefix}/${skin}/home4/screenshot.jpg",
				'import_notice'              => esc_html__( 'After you import this demo, you will have to setup the slider separately.', 'puca' ),
				'preview_url'                => 'https://elementor.thembay.com/puca_smarket2/home-4/',
			),
			array(
				'import_file_name'           => 'Home 5',
				'home'                       => 'home-5',
				...
				'import_preview_image_url'   => "https://bitbucket.org/devthembay/update-plugin/raw/master/demosamples/puca/${prefix}/${skin}/home5/screenshot.jpg",
				'import_notice'              => esc_html__( 'After you import this demo, you will have to setup the slider separately.', 'puca' ),
				'preview_url'                => 'https://elementor.thembay.com/puca_smarket2/home-5/',
				'group_label_end'          => 'yes',
			),
		);
	}
	...
	public function import_files_wpb_el_furniture(){
		...
		return array(
			array(
				...
				'import_preview_image_url'   => "https://bitbucket.org/devthembay/update-plugin/raw/master/demosamples/puca/${prefix}/${skin}/home1/screenshot.jpg",
				'import_notice'              => esc_html__( 'After you import this demo, you will have to setup the slider separately.', 'puca' ),
				'preview_url'                => 'https://elementor.thembay.com/puca_ohio/',
				'group_label_start'          => 'yes',
				'group_label_name'          => $prefix_name.' '. $skin_name,
			),
			array(
				...
				'import_preview_image_url'   => "https://bitbucket.org/devthembay/update-plugin/raw/master/demosamples/puca/${prefix}/${skin}/home2/screenshot.jpg",
				'import_notice'              => esc_html__( 'After you import this demo, you will have to setup the slider separately.', 'puca' ),
				'preview_url'                => 'https://elementor.thembay.com/puca_ohio/home-2/',
			),
			array(
				'import_file_name'           => 'Home 3',
				'home'                       => 'home-3',
				...
				'import_preview_image_url'   => "https://bitbucket.org/devthembay/update-plugin/raw/master/demosamples/puca/${prefix}/${skin}/home3/screenshot.jpg",
				'import_notice'              => esc_html__( 'After you import this demo, you will have to setup the slider separately.', 'puca' ),
				'preview_url'                => 'https://elementor.thembay.com/puca_ohio/home-3/',
			),
			array(
				'import_file_name'           => 'Home 4',
				'home'                       => 'home-4',
				...
				'import_preview_image_url'   => "https://bitbucket.org/devthembay/update-plugin/raw/master/demosamples/puca/${prefix}/${skin}/home4/screenshot.jpg",
				'import_notice'              => esc_html__( 'After you import this demo, you will have to setup the slider separately.', 'puca' ),
				'preview_url'                => 'https://elementor.thembay.com/puca_ohio/home-4/',
			),
			array(
				'import_file_name'           => 'Home 5',
				'home'                       => 'home-5',
				...
				'import_preview_image_url'   => "https://bitbucket.org/devthembay/update-plugin/raw/master/demosamples/puca/${prefix}/${skin}/home5/screenshot.jpg",
				'import_notice'              => esc_html__( 'After you import this demo, you will have to setup the slider separately.', 'puca' ),
				'preview_url'                => 'https://elementor.thembay.com/puca_ohio/home-5/',
			),
			array(
				'import_file_name'           => 'Home 6',
				'home'                       => 'home-6',
				...
				'import_preview_image_url'   => "https://bitbucket.org/devthembay/update-plugin/raw/master/demosamples/puca/${prefix}/${skin}/home6/screenshot.jpg",
				'import_notice'              => esc_html__( 'After you import this demo, you will have to setup the slider separately.', 'puca' ),
				'preview_url'                => 'https://elementor.thembay.com/puca_ohio/home-6/',
			),
			array(
				'import_file_name'           => 'Home 7',
				'home'                       => 'home-7',
				...
				'import_preview_image_url'   => "https://bitbucket.org/devthembay/update-plugin/raw/master/demosamples/puca/${prefix}/${skin}/home7/screenshot.jpg",
				'import_notice'              => esc_html__( 'After you import this demo, you will have to setup the slider separately.', 'puca' ),
				'preview_url'                => 'https://elementor.thembay.com/puca_ohio/home-7/',
			),
			array(
				'import_file_name'           => 'Home 8',
				'home'                       => 'home-8',
				...
				'import_preview_image_url'   => "https://bitbucket.org/devthembay/update-plugin/raw/master/demosamples/puca/${prefix}/${skin}/home8/screenshot.jpg",
				'import_notice'              => esc_html__( 'After you import this demo, you will have to setup the slider separately.', 'puca' ),
				'preview_url'                => 'https://elementor.thembay.com/puca_ohio/home-8/',
			),
			array(
				'import_file_name'           => 'Home 9',
				'home'                       => 'home-9',
				...
				'import_preview_image_url'   => "https://bitbucket.org/devthembay/update-plugin/raw/master/demosamples/puca/${prefix}/${skin}/home9/screenshot.jpg",
				'import_notice'              => esc_html__( 'After you import this demo, you will have to setup the slider separately.', 'puca' ),
				'preview_url'                => 'https://elementor.thembay.com/puca_ohio/home-9/',
			),
			array(
				'import_file_name'           => 'Home 10',
				'home'                       => 'home-10',
				...
				'import_preview_image_url'   => "https://bitbucket.org/devthembay/update-plugin/raw/master/demosamples/puca/${prefix}/${skin}/home10/screenshot.jpg",
				'import_notice'              => esc_html__( 'After you import this demo, you will have to setup the slider separately.', 'puca' ),
				'preview_url'                => 'https://elementor.thembay.com/puca_ohio/home-10/',
			),
			array(
				'import_file_name'           => 'Home 11',
				'home'                       => 'home-11',
				...
				'import_preview_image_url'   => "https://bitbucket.org/devthembay/update-plugin/raw/master/demosamples/puca/${prefix}/${skin}/home11/screenshot.jpg",
				'import_notice'              => esc_html__( 'After you import this demo, you will have to setup the slider separately.', 'puca' ),
				'preview_url'                => 'https://elementor.thembay.com/puca_ohio/home-11/',
			),
			array(
				'import_file_name'           => 'Home 12',
				'home'                       => 'home-12',
				...
				'import_preview_image_url'   => "https://bitbucket.org/devthembay/update-plugin/raw/master/demosamples/puca/${prefix}/${skin}/home12/screenshot.jpg",
				'import_notice'              => esc_html__( 'After you import this demo, you will have to setup the slider separately.', 'puca' ),
				'preview_url'                => 'https://elementor.thembay.com/puca_ohio/home-12/',
			),
			array(
				'import_file_name'           => 'Home 13',
				'home'                       => 'home-13',
				...
				'import_preview_image_url'   => "https://bitbucket.org/devthembay/update-plugin/raw/master/demosamples/puca/${prefix}/${skin}/home13/screenshot.jpg",
				'import_notice'              => esc_html__( 'After you import this demo, you will have to setup the slider separately.', 'puca' ),
				'preview_url'                => 'https://elementor.thembay.com/puca_ohio/home-13/',
			),
			array(
				'import_file_name'           => 'Home 14',
				'home'                       => 'home-14',
				...
				'import_preview_image_url'   => "https://bitbucket.org/devthembay/update-plugin/raw/master/demosamples/puca/${prefix}/${skin}/home14/screenshot.jpg",
				'import_notice'              => esc_html__( 'After you import this demo, you will have to setup the slider separately.', 'puca' ),
				'preview_url'                => 'https://elementor.thembay.com/puca_ohio/home-14/',
			),
			array(
				...
				'import_notice'              => esc_html__( 'After you import this demo, you will have to setup the slider separately.', 'puca' ),
				'preview_url'                => 'https://elementor.thembay.com/puca_ohio/home-15/',
			),
			array(
				...
				'import_notice'              => esc_html__( 'After you import this demo, you will have to setup the slider separately.', 'puca' ),
				'preview_url'                => 'https://elementor.thembay.com/puca_ohio/home-16/',
			),
			array(
				...
				'import_notice'              => esc_html__( 'After you import this demo, you will have to setup the slider separately.', 'puca' ),
				'preview_url'                => 'https://elementor.thembay.com/puca_ohio/home-17/',
			),
			array(
				...
				'import_notice'              => esc_html__( 'After you import this demo, you will have to setup the slider separately.', 'puca' ),
				'preview_url'                => 'https://elementor.thembay.com/puca_ohio/home-18/',
			),
			array(
				...
				'import_notice'              => esc_html__( 'After you import this demo, you will have to setup the slider separately.', 'puca' ),
				'preview_url'                => 'https://elementor.thembay.com/puca_ohio/home-19/',
			),
			array(
				...
				'import_notice'              => esc_html__( 'After you import this demo, you will have to setup the slider separately.', 'puca' ),
				'preview_url'                => 'https://elementor.thembay.com/puca_ohio/home-20/',
			),
			array(
				...
				'import_notice'              => esc_html__( 'After you import this demo, you will have to setup the slider separately.', 'puca' ),
				'preview_url'                => 'https://elementor.thembay.com/puca_ohio/home-21/',
			),
			array(
				...
				'import_notice'              => esc_html__( 'After you import this demo, you will have to setup the slider separately.', 'puca' ),
				'preview_url'                => 'https://elementor.thembay.com/puca_ohio/home-22/',
			),
			array(
				...
				'import_notice'              => esc_html__( 'After you import this demo, you will have to setup the slider separately.', 'puca' ),
				'preview_url'                => 'https://elementor.thembay.com/puca_ohio/home-23/',
			),
			array(
				...
				'import_notice'              => esc_html__( 'After you import this demo, you will have to setup the slider separately.', 'puca' ),
				'preview_url'                => 'https://elementor.thembay.com/puca_ohio/home-24/',
				'group_label_end'          => 'yes',
			),
		);
	}
