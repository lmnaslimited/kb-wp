...
class puca_Tbay_Recent_Post extends Tbay_Widget {
    public function __construct() {
        parent::__construct(
            'tbay_recent_post',
            esc_html__('Tbay Recent Posts Widget', 'puca'),
            array( 'description' => esc_html__( 'Show list of recent post', 'puca' ), )
        );
