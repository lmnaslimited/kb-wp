...
class puca_Tbay_Popular_Post2 extends Tbay_Widget {
    public function __construct() {
        parent::__construct(
            'tbay_popular_post2',
            esc_html__('Tbay Popular Posts 2 Widget', 'puca'),
            array( 'description' => esc_html__( 'Show list of popular posts Only Fashion 2', 'puca' ), )
        );
        $this->widgetName = 'popular_post2';
    }
 
    public function getTemplate() {
        $this->template = 'popular-post2.php';
    }
