...
class Puca_Elementor_Supermaket_Categories_Tabs extends  Puca_Elementor_Carousel_Base{
    ...
    public function render_product_tab($categories, $_id) {
                ...
                <div class="tab-content">
                 ...
                 foreach ($categories as $tab ) {
                     $tab_active = ($__count == 0) ? ' active' : '';
                         $this->render_content_tab($tab, $tab_active, $_id);
                     $__count++;
                 }
                 ?>
                </div>
    ...
    private function  render_content_tab($tab, $tab_active, $_id) {
        $settings = $this->get_settings_for_display();
        ...
        /** Get Query Products */
        $loop = $this->get_query_products($cat,  $cat_operator, $product_type, $limit, $orderby, $order);
...
$widgets_manager->register_widget_type(new Puca_Elementor_Supermaket_Categories_Tabs());
