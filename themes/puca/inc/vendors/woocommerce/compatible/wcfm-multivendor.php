...
if(! function_exists( 'puca_tbay_wcfm_addclass_sidebar_right' ) ) {
    function puca_tbay_wcfm_addclass_sidebar_right() {
        global $WCFMmp;
    ...
    add_filter( 'wcfm_store_wrapper_class', 'puca_tbay_wcfm_addclass_sidebar_right', 10, 2 );
    add_filter( 'wcfm_store_lists_wrapper_class', 'puca_tbay_wcfm_addclass_sidebar_right', 10, 2 );
}

if(!function_exists('puca_wcfm_shop_vendor_name')){
    function puca_wcfm_shop_vendor_name() {
        global $WCFMmp;
    ...
    add_action('woocommerce_before_shop_loop_item_title', 'puca_wcfm_shop_vendor_name', 5);
}

if(!function_exists('puca_tbay_wcfm_group_info_vendor_single_product_open')){
    function  puca_tbay_wcfm_group_info_vendor_single_product_open() {
        global $WCFMmp, $WCFM;
...
if(!function_exists('puca_tbay_wcfm_group_info_vendor_single_product_close')){
    function  puca_tbay_wcfm_group_info_vendor_single_product_close() {
        echo '</div>';
    }
}

if(!function_exists('puca_tbay_wcfm_vendor_sold_by_position')){
    add_action('woocommerce_before_single_product','puca_tbay_wcfm_vendor_sold_by_position', 40);
    function  puca_tbay_wcfm_vendor_sold_by_position() {
        global $WCFMmp, $WCFM;
        ...
        switch ($vendor_sold_by_position) {
            case 'bellow_title':
                add_action('woocommerce_single_product_summary','puca_tbay_wcfm_group_info_vendor_single_product_open', 5);
                add_action('woocommerce_single_product_summary','puca_tbay_wcfm_group_info_vendor_single_product_close', 9);
            break;         

            case 'bellow_price':
                add_action('woocommerce_single_product_summary','puca_tbay_wcfm_group_info_vendor_single_product_open', 12);
                add_action('woocommerce_single_product_summary','puca_tbay_wcfm_group_info_vendor_single_product_close', 18);
            break;        

            case 'bellow_sc':
                add_action('woocommerce_single_product_summary','puca_tbay_wcfm_group_info_vendor_single_product_open', 22);
                add_action('woocommerce_single_product_summary','puca_tbay_wcfm_group_info_vendor_single_product_close', 27);
            break;
             
            default:
                add_action('woocommerce_product_meta_start','puca_tbay_wcfm_group_info_vendor_single_product_open', 10);
                add_action('woocommerce_product_meta_start','puca_tbay_wcfm_group_info_vendor_single_product_close', 99);
            break;
        }
    }
}
...
if ( ! function_exists( 'puca_tbay_wcfm_get_title_mobile' ) ) {
    function puca_tbay_wcfm_get_title_mobile( $title = '') {
        global $post; 
    ...
    add_filter( 'puca_get_filter_title_mobile', 'puca_tbay_wcfm_get_title_mobile', 10, 1 );
}
