...
$btn_align = $add_icon = $link = $style = $el_class = $css = $css_animation = '';
...
$class_to_filter = 'tbay-addon-button text-'. $btn_align .' '. $btn_icon_class .' btn';
