			...
			<div class="<?php echo esc_attr( $layout_type ); ?>-wrapper">
                ...
                <?php else : ?>
                    ...
                    <div class="row grid" <?php echo esc_attr($data_responsive); ?>>
                        <?php  wc_get_template( 'layout-categories/'.  $active_theme .'/'.  $layout_type .'-custom.php' , array( 'categoriestabs' => $categoriestabs, 'display_count' => $display_count, 'columns' => $columns , 'screen_desktop' => $screen_desktop, 'screen_desktopsmall' => $screen_desktopsmall, 'screen_tablet' => $screen_tablet, 'screen_mobile' => $screen_mobile ) ); ?>
                    </div>
                ...
                if( $button_show_type === 'all' ) {
                    ...
                    echo '<div class="show-view-all"><a href="'. esc_url($aUrl) .'">'. esc_html($show_all_text) .'</a></div>';
                }
