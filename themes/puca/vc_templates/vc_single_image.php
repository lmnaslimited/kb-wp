...
if ( ! $img ) {
	$img['thumbnail'] = puca_tbay_src_image_loaded($default_src, array('class' => 'vc_img-placeholder vc_single_image-img'), false);
}
...
$wrapperClass = 'vc_single_image-wrapper tbay-image-loaded ' . $style . ' ' . $border_color;
