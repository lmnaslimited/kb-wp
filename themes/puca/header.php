...
<head>
	...
	<meta name="description" content="Now get your everyday essential vegetables delivered at your doorstep ! Order online now at KaykariBasket for Farm Fresh vegetables">
...
<?php $tbay_header = apply_filters( 'puca_tbay_get_header_layout', puca_tbay_get_config('header_type', 'v1') );
	  ...
	  $mobile_footer_type = (puca_tbay_get_config('mobile_footer_type', 'v1') === 'v1') ? '' : puca_tbay_get_config('mobile_footer_type', 'v1');
	?>
<div id="wrapper-container" class="wrapper-container <?php echo esc_attr($tbay_header); ?>">
	...
	<?php 
		if( puca_tbay_get_config('mobile_footer_icon',true) ) {
			puca_tbay_get_page_templates_parts('device/footer-mobile', $mobile_footer_type);
		}
	 ?>
