    ...
    $("form.variations_form").on('change', function () {
      ...
      if (!_this.find('.single_variation_wrap .single_variation .woocommerce-variation-price').is(':empty')) {
        if (!_this.find('.single_variation_wrap .single_variation').is(':empty')) {
          _this.find('.mobile-infor-wrapper .infor-body').empty().append(_this.find('.single_variation_wrap .single_variation').html());
        } else {
          _this.find('.mobile-infor-wrapper .infor-body').empty().append(_this.parent().find('.price').html());
        }
      }
