...
class TimeCircles {
  initCountDownTimer() {
    $('[data-countdown="countdown"], [data-time="timmer"]').each(function () {
      var id = $(this).data('id');
...
jQuery(document).ready(function () {
  ...
  timecircles.initCountDownTimer();
...
jQuery(window).on('elementor/frontend/init', function () {
  if (typeof puca_settings !== "undefined" && jQuery.isArray(puca_settings.elements_ready.countdowntimer)) {
