...
( function( api ) {
	var cssTemplate = wp.template( 'puca-color-scheme' ),
		colorSchemeKeys = [
			'background_color',
	...
	function updateCSS() {
		...
		colors.border_puca_color = Color( colors.textcolor ).toCSS( 'rgba', 0.3 );
		...
		colors.sidebar_border_puca_color = Color( colors.sidebar_textcolor ).toCSS( 'rgba', 0.3 );
