...
$review_text = $count > 1 ? esc_html__('Reviews', 'puca') : esc_html__('Review', 'puca');
?> 
<div style="clear:both; width:100%;"></div> 
<a href="#reviews">
    <span itemprop="reviewRating" itemscope itemtype="http://schema.org/Rating" class="star-rating" title="<?php echo sprintf(__('Rated %s out of 5', 'puca'), $rating) ?>">
        <span style="width:<?php echo trim(( $rating / 5 ) * 100); ?>%"><strong itemprop="ratingValue"><?php echo trim($rating); ?></strong> <?php esc_html_e('out of 5', 'puca'); ?></span>
    </span>
