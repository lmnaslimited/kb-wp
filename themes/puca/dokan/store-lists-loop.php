        ...
        <?php if ( $sellers['users'] ) : ?>
            <ul class="dokan-seller-wrap">
                ...
                foreach ( $sellers['users'] as $seller ) {
                    ...
                    $store_name = isset( $store_info['store_name'] ) ? $store_info['store_name'] : esc_html__( 'N/A', 'puca' );
                    ...
                    <li class="dokan-single-seller woocommerce coloum-<?php echo esc_attr($per_row); ?> <?php echo esc_attr(( ! $banner_id ) ? 'no-banner-img' : ''); ?>">
                                            ...
                                            <?php if ( !empty( $seller_rating['count'] ) ): ?>
                                                <div class="star-rating dokan-seller-rating" title="<?php echo sprintf(__( 'Rated %s out of 5', 'puca' ), $seller_rating['rating'] ) ?>">
                                                    <span style="width: <?php echo ( ( $seller_rating['rating']/5 ) * 100 - 1 ); ?>%">
                                                        <strong class="rating"><?php echo trim($seller_rating['rating']); ?></strong> <?php esc_html_e('out of 5', 'puca'); ?>
                                                    </span>
                                                </div>
                                            <?php endif ?>
